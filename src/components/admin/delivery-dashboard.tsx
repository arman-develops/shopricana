...
const activeDeliveries = [
  {
    ...
    address: "Moi Avenue, Nairobi CBD, 00100",
    driver: "Brian Kiptoo",
  ...
  },
  {
    ...
    driver: "Kevin Njoroge",
    driverPhone: "+254 713 456789",
    status: "picked_up",
  ...
  {
    id: "ORD-KE-003",
    customer: "Wanjiru Njeri",
    address: "Thika Road, Roysambu, Nairobi",
    driver: "Linet Auma",
    driverPhone: "+254 714 567890",
    status: "preparing",
  ...
  {
    id: "ORD-KE-004",
    customer: "Samuel Mwendwa",
    address: "Moi Avenue, Mombasa",
    driver: "Alex Musyoka",
    driverPhone: "+254 715 678901",
    status: "delayed",
