...
const orders = [
  {
    ...
    items: 3,
    total: 4599.97,
    shippingAddress: "Moi Avenue, Nairobi, 00100",
    paymentMethod: "M-PESA",
  },
  {
    id: "ORD-KE-002",
    customer: "Achieng Atieno",
    email: "achieng.atieno@example.co.ke",
    date: "2024-01-15",
    status: "shipped",
    items: 1,
    total: 1799.00,
    shippingAddress: "Oginga Odinga Street, Kisumu",
  ...
  },
  {
    ...
    items: 5,
    total: 5670.45,
    shippingAddress: "Kiptagich Road, Nakuru",
    paymentMethod: "M-PESA",
  },
  {
    id: "ORD-KE-004",
    customer: "Wanjiku Njeri",
    email: "wanjiku.njeri@example.co.ke",
    date: "2024-01-14",
    status: "pending",
    items: 2,
    total: 1999.98,
    shippingAddress: "Kenyatta Avenue, Thika",
    paymentMethod: "Credit Card",
  },
  {
    id: "ORD-KE-005",
    customer: "Michael Oduor",
    email: "michael.oduor@example.co.ke",
    date: "2024-01-13",
    status: "cancelled",
    items: 1,
    total: 1499.99,
    shippingAddress: "Makupa Road, Mombasa",
    paymentMethod: "M-PESA",
  },
];
