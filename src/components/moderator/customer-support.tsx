...
const supportTickets: SupportTicket[] = [
  {
    ...
    subject: "Order not received - Nairobi CBD",
    priority: "high",
    status: "open",
    category: "shipping",
    created: "2 hours ago",
  ...
  },
  {
    ...
    email: "achieng.otieno@example.co.ke",
    subject: "Defective phone charger - InfiCharge Pro",
    priority: "medium",
    status: "pending",
    category: "product",
    created: "4 hours ago",
  ...
  },
  {
    ...
    email: "bkiptoo@example.co.ke",
    subject: "Refund request for overcharge (M-PESA)",
    priority: "normal",
    status: "resolved",
    category: "billing",
    created: "1 day ago",
