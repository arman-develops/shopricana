...
const disputes: Dispute[] = [
  {
    ...
    merchant: "SmartTech KE",
    orderNumber: "ORD-KE-00123",
    amount: 4599.99,
    status: "pending",
    priority: "high",
    created: "2024-01-15 14:30:00",
    description: "Phone arrived with a cracked screen, requesting full refund",
    evidence: ["cracked_screen.jpg", "delivery_box.jpg"],
  },
  {
    id: "DSP-002",
    type: "delivery",
    customer: "Achieng Otieno",
    merchant: "UrbanStyle Trends",
    orderNumber: "ORD-KE-00124",
    amount: 1799.00,
    status: "investigating",
    priority: "medium",
    created: "2024-01-15 12:15:00",
    description: "Courier marked package as delivered but it never arrived",
    evidence: ["tracking_screenshot.pdf"],
  },
  {
    id: "DSP-003",
    type: "quality",
    customer: "Brian Kiptoo",
    merchant: "Zuri Homewares",
    orderNumber: "ORD-KE-00125",
    amount: 3250.50,
    status: "resolved",
    priority: "low",
    created: "2024-01-14 16:45:00",
    description: "The blender received is smaller and less powerful than advertised",
    evidence: ["product_comparison.jpg"],
  },
  {
    id: "DSP-004",
    type: "billing",
    customer: "Wanjiku Njeri",
    merchant: "EduSupplies Hub",
    orderNumber: "ORD-KE-00126",
    amount: 1120.00,
    status: "escalated",
    priority: "high",
    created: "2024-01-14 10:20:00",
    description: "Charged twice for the same order of school supplies",
    evidence: ["mpesa_receipt1.pdf", "mpesa_receipt2.pdf"],
  },
];
